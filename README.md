...
<h1 align="center">Push Notifications API</h1>
...
<p align="center">
  <a href="https://play.google.com/store/apps/details?id=com.viktorholk.apipushnotifications"><img src="https://img.shields.io/badge/Google_Play-Download-green?logo=google-play" alt="Google Play"></a>
  <a href="https://github.com/viktorholk/push-notifications-api/releases"><img src="https://img.shields.io/github/v/release/viktorholk/push-notifications-api" alt="GitHub Release"></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/viktorholk/push-notifications-api" alt="License"></a>
</p>

<p align="center">
  <img src="https://github.com/user-attachments/assets/7f6e2fc4-acb6-4f8d-b369-b91be488fbb2" alt="App Preview" />
</p>

## About

Push Notifications API is an open-source tool for developers who need a simple way to send notifications to their phone. The application is great for IoT projects — for example, post a notification when a sensor detects low soil moisture, or when a build pipeline fails.
...
Download the Android app from [Google Play](https://play.google.com/store/apps/details?id=com.viktorholk.apipushnotifications), [IzzyOnDroid](https://apt.izzysoft.de/fdroid/index/apk/com.viktorholk.apipushnotifications), or grab the latest APK from [GitHub Releases](https://github.com/viktorholk/push-notifications-api/releases).
...
2. **Configure** (optional) — create a `.env` file:
   ```env
   HOST=0.0.0.0
   PORT=3000
   ```
...
2. Tap **Register & Connect** — a device token is generated automatically
...
Creates a new device and returns a unique token. The Android app calls this automatically when you tap **Register & Connect** — you only need this endpoint if you're building a custom client.
...
| `since` | string | No | ISO 8601 timestamp — only return notifications created after this time |
...
**Response** `200 OK` — notification object, or `404` if none exist.
...
![notification settings](https://github.com/user-attachments/assets/12685adf-7a74-4915-bda6-045175031afb)

</details>

<details><summary>Connection keeps dropping</summary>
...
Push Notifications API is licensed under the [MIT License](LICENSE).
